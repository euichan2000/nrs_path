...
void interpolatedWaypointsCallback(const nrs_ver2::Waypoints::ConstPtr &msg);
...
{
    ros::init(argc, argv, "moveit_planner_node");
    ros::NodeHandle nh;
    ...
    ros::Subscriber interpolated_waypoints_sub = nh.subscribe("final_waypoints", 10, interpolatedWaypointsCallback);
    ...
    std::map<std::string, double> initial_pose = {
        {"shoulder_pan_joint", -9.0 * M_PI / 180},
        {"shoulder_lift_joint", -92.33 * M_PI / 180},
        {"elbow_joint", -94.49 * M_PI / 180},
        {"wrist_1_joint", -84.22 * M_PI / 180},
        {"wrist_2_joint", 88.60 * M_PI / 180},
        {"wrist_3_joint", 35.86 * M_PI / 180}};
        ...
        if (start_planning)
        {
            ...
            if (current_waypoints.size() > 1)
            {
                ...
                if (fraction > 0.0)
                {
                    ...
                    // std::string file_path = using_interpolated_waypoints ? "/home/nrs/catkin_ws/src/nrs_ver2/data/interpolated_joint_states.txt" : "/home/nrs/catkin_ws/src/nrs_ver2/data/joint_states.txt";
                    // saveJointStatesToFile(plan, file_path);

                    // std::string file_path2 = "/home/nrs/catkin_ws/src/nrs_ver2/data/tcp_states.txt";
