...
std::vector<geometry_msgs::Point> clicked_points; // Published Points
...
// path generating start when keyboardcallback fuction operate
...
// Calculate Geodesic interpolation parameters
void updateInterpolationParameters(std::vector<Eigen::Vector3d> &selected_points, bool chord_length)
{
...
// visualize ContolPoints
void visualizeControlPoints(const Eigen::Vector3d &point, visualization_msgs::MarkerArray &marker_array, int &marker_id, const std::string &ns, const std::string &frame_id)
{
